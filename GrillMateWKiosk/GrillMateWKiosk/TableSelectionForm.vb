            ...
            Using connection As New SqlConnection(connectionString)
                ...
                Using command As New SqlCommand(query, connection)
                    Using reader As SqlDataReader = command.ExecuteReader()
                        ...
                        ' Calculate starting Y position (we'll center after we know the actual count)
                        ...
                        While reader.Read()
                            ...
                            ' Set button color and state based on status
                            ...
                            ' Add click event handler for vacant tables

...
Public Class MenuDashboardForm
    ...
    Private connectionString As String = "Data Source=Aegon;Initial Catalog=POS;Integrated Security=True"
    ...
    Private Function ProcessOrder() As String
        Try
            Using connection As New SqlConnection(connectionString)
                ...
                Dim orderNumber As String = GetNextOrderNumber(connection)
                ...
                Using orderCommand As New SqlCommand(orderQuery, connection)
                    orderCommand.Parameters.AddWithValue("@TableID", SelectedTableID)
                ...
                Using orderIdCommand As New SqlCommand(orderIdQuery, connection)
                    orderIdCommand.Parameters.AddWithValue("@OrderNumber", orderNumber)
                ...
                For Each item As CartItem In cartItems
                    ...
                    Using itemCommand As New SqlCommand(itemQuery, connection)
                ...
                Using updateTableCommand As New SqlCommand(updateTableQuery, connection)
                    updateTableCommand.Parameters.AddWithValue("@TableID", SelectedTableID)
    ...
    Private Function GetNextOrderNumber(connection As SqlConnection) As String
        Try
            ...
            Using command As New SqlCommand(query, connection)
                command.Parameters.AddWithValue("@Pattern", "ORD-" & today & "-%")
                Dim lastNumber As Integer = Convert.ToInt32(command.ExecuteScalar())
